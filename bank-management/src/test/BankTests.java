...
public class BankTests {
    ...
    public void setup() {
        bank = new Bank();
        bank.addAccount(new Chequing(new Chequing("f84c43f4-a634-4c57-a644-7602f8840870", "Michael Scott", 1524.51)));
    }
    ...
    public void taxDeduction() {
        ...
        assertEquals(5374.51, bank.getAccount("f84c43f4-a634-4c57-a644-7602f8840870").getBalance(), 0);
    } 
}
